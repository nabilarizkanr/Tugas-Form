...
<tr>
	...
	<th colspan="2"><center>Fungsi</center></th>
		...
		<tr>
			...
			<td><?=$data['stok']?></td>
			<td><a  class='btn btn-info' href='index.php?hal=edit&id_buku=<?=$data['id_buku']?>'>Edit</a> | <a  class='btn btn-danger' href='index.php?hal=hapus&id<?=$data['id_buku']?>' onclick="return confirm('Apakah yakin ingin menghapus data ini?')">Delete</a></td>
		</tr>
